...
# Form implementation generated from reading ui file 'food_warn_popup.ui'
#
...
class Ui_mainFrame(object):
    def setupUi(self, mainFrame):
        ...
        mainFrame.resize(283, 310)
        mainFrame.setMinimumSize(QtCore.QSize(250, 250))
...
"border-radius: 30px;")
        ...
        self.warn.setStyleSheet("background-color: rgb(217, 217, 217);\n"
"border-radius: 0px;")
        self.warn.setAlignment(QtCore.Qt.AlignCenter)
        self.warn.setObjectName("warn")
        self.gridLayout.addWidget(self.warn, 1, 0, 1, 2)
...
"}")
        ...
        self.gridLayout.addWidget(self.confirm, 4, 1, 1, 1)
...
"border-top-left-radius: 20px;")
    ...
    def retranslateUi(self, mainFrame):
        ...
        self.warn.setText(_translate("mainFrame", "사료 잔량이\n"
"10% 미만입니다!!\n"
"구입을 원하시면\n"
"확인버튼을 눌러주세요!!"))
